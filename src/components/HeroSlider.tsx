...
const slides = [
  {
    ...
    description: 'Decouvrez nos burgers gourmet, prepares avec des ingredients frais et notre pain Cheese Naan signature.',
  ...
  {
    title: 'Cheese Naan',
    subtitle: 'Notre specialite signature',
    description: 'Notre pain maison unique pour sublimer vos sandwichs.',
    cta: 'Voir les Sandwichs',
    category: 'sandwichs',
